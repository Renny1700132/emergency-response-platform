...
G1-01、G1-01-A、G1-01-A-BR、G1-02、G1-03、G1-04、G1-05 与 G1-07 已完成；G1-06 处于 `REVIEW`。G1-07 的计划关联按 `OVR-013` 保留待 G1-06 完成后的非阻断滚动复查。G1-08 及后续任务只有在用户或其主责成员明确启动时才执行，不因前置完成而自动开始。
