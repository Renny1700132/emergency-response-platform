...
本仓库用于《AI 辅助软件项目全生命周期开发·综合实习》课程项目。第一关“立项竞标”已完成收口与最终冻结；后续阶段仅在用户或主责成员明确启动后开展。

第一关已完成需求与招标解析、编标输入基线、项目建议书、技术方案、澄清与合规检查、项目计划、风险登记册、技术投标书、述标、需求确认书及最终冻结。
...
当前计划见 `tasks.md`；正式交付物包括技术投标文件、项目建议书、澄清与质询记录、项目计划 v1、风险登记册 v1、需求确认书及述标答辩讲稿与策略。
