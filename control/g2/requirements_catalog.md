...
- 状态：DONE（2026-09-13 B 复核通过；四处故事映射已修订并经 B 复验关闭）
- 编号范围：`G2-FR-001`—`G2-FR-039`（001—029 为 MVP Must；030—039 为非 MVP、本期范围）
...
| G2-FR-009 | FR-03.4 | 是 | 制定盘点计划，移动盘点并自动比对、标识差异。 | MVP-3 | US-022 | F-111 | MUST / INHERITED_FROZEN |
...
| G2-FR-017 | FR-06.1 | 是 | 配置值班打卡小组、时段、点位及代执行留痕。 | MVP-3 | US-024 | F-119 | MUST / INHERITED_FROZEN |
...
| G2-FR-021 | FR-08.1 | 是 | H5 移动发起事件、拍照并查看个人事件。 | MVP-3 | US-017 | F-128 | MUST / INHERITED_FROZEN |
| G2-FR-022 | FR-08.2 | 是 | 移动接收、确认、反馈、上传并完成任务。 | MVP-3 | US-018、US-028 | F-129；KN-006、007 | MUST / DEPENDENCY_PENDING_VALIDATION |
| G2-FR-023 | FR-08.4 | 是 | 移动查看、执行演练并提交结果。 | MVP-3 | US-019 | F-131 | MUST / INHERITED_FROZEN |
...
## 2 非 MVP、仍属本期范围（稳定编号已补齐）

| G2 稳定编号 | 原始 FR | ★ | MVP 优先级 | 期次标记 | 忠实摘要 | 权威事实 |
| --- | --- | --- | --- | --- | --- | --- |
| G2-FR-030 | FR-01.4 | 否 | Should | 非 MVP / 本期 | 管理预案附件、检索、修订和版本；标准示例模板为宜提供。 | F-103 |
| G2-FR-031 | FR-03.1 | 是 | Should | 非 MVP / 本期 | 管理应急人员档案、职责、小组和调派通知。 | F-108 |
| G2-FR-032 | FR-03.2 | 否 | Should | 非 MVP / 本期 | 管理值班计划并与打卡联动，调整留痕。 | F-109 |
| G2-FR-033 | FR-07.1 | 否 | Should | 非 MVP / 本期 | 维护预案类型，支持新增、修改和停用。 | F-123 |
| G2-FR-034 | FR-07.2 | 是 | Should | 非 MVP / 本期 | 维护事件类型；可预置四大类。 | F-124 |
| G2-FR-035 | FR-07.3 | 是 | Should | 非 MVP / 本期 | 配置物资站点空间和地图位置。 | F-125 |
| G2-FR-036 | FR-07.4 | 是 | Should | 非 MVP / 本期 | 维护条目化、可复用的评估模板。 | F-126 |
| G2-FR-037 | FR-07.5 | 是 | Should | 非 MVP / 本期 | 自定义核实审批环节、人员和时限，并留存调整记录。 | F-127 |
| G2-FR-038 | FR-08.3 | 否 | Should | 非 MVP / 本期 | H5 提供知识库分类和关键字检索。 | F-130 |
| G2-FR-039 | FR-09.1 | 是 | Could | 非 MVP / 本期 | 统计应急事件、监控和流程，支持筛选与钻取。 | F-134；KN-017 |
## 3 编号完整性结论

- `G2-FR`：39 个、连续、无重复；001—029 为 MVP Must，030—039 为非 MVP、本期范围。
- 原始 MVP FR：29 个唯一值、无遗漏、无额外项。
- ★：28 条；非★：1 条（FR-02.4）。该计数只针对 29 条 MVP FR，不替代全项目 34 条★/39 条 FR 的总计。
- 非 MVP：10 条，均已分配 G2-FR-030—039 并保留本期范围；当前无 Won't。
- G2-01 的四处故事语义偏差已由 C 修订并经 B 复验关闭，见 `ISSUE-G2-02-001`。本目录继续以 P1 冻结 FR 含义为准。
