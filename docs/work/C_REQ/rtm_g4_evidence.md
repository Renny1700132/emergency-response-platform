...
| G4-07 | G4-05/G4-06 Sprint 1 集成准出；G2-FR-013/014/015/016/021/022；KN-045；ENG-015/017。KN-006/007/011/012 目标环境实测不在本任务冒充完成，保留至 G4-10/验收 | `frontend/tests/real-stack-e2e.test.ts`：真实 Vue 页面 + 正式 API Client + Bearer + 实际后端 HTTP Server，完成事件上报/核实/启动、任务接收/反馈/完成、事件关闭及 403；完整 `npm run quality`：frontend 28/28，覆盖率 95.41/77.55/95.12/100%，G4 11/11，backend 16/16，后端覆盖率 85.88/78.24/80.48/85.88%，OpenAPI 0 error/14 warning，漏洞 0。C 在独立 PostgreSQL 18 测试库应用 001/002 迁移后专项 2/2 PASS；空库首次缺表 0/2 失败未隐藏；同时回指 G4-05 PostgreSQL 15 2/2 与 A 复验 | `ISSUE-G4-07-001/002/003` 均关闭；报告 `evidence/g4/G4-07/sprint1-gate-report.md`；`quality/selfcheck/G4-07.json`；待 B Review/Approve 与 PR Merge | DONE CANDIDATE / PENDING_B_REVIEW；外部身份、文件、消息仍为 SIMULATED_EVIDENCE，不声明甲方真实环境或性能验收完成。 |
