...
import H5ModuleView from '../views/h5/H5ModuleView.vue'
...
const routes=[
  ...
  {path:'/web',component:WebLayout,children:[
    ...
    ...webModules.map(module=>({path:module.path,component:ModuleView,props:{module},meta:{title:module.title}}))
  ]},
  {path:'/h5',component:H5Layout,children:[
    {path:'',redirect:'/h5/home'},
    {path:'home',component:H5HomeView,meta:{title:'移动应急'}},
    ...h5Modules.map(module=>({path:module.path,component:H5ModuleView,props:{module},meta:{title:module.title}}))
  ]},
