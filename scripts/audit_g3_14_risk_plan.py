...
def main() -> None:
    ...
    result={"task":"G3-14","pass":not problems,"problems":problems,"counts":{"tables_total":len(doc.tables),"business_tables":len(doc.tables)-1,"captions":len(doc_caps),"adjacent_caption_table_pairs":adjacent,"risk_ids":len(rows)},"task_status":"REVIEW"}
