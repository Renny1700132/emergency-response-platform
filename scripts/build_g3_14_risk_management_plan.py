...
def build() -> None:
    ...
    cover={0:"文档编号：YJGL-G3-14-RMP　　版本号：V0.2",1:"密　　级：内部 · 教学用",3:"某自然博物馆智能运营中心建设项目——应急管理子系统",4:"风险管理计划与风险登记册 v2",5:"（G3-14 评审候选）",7:"编制单位：020202项目组【待人工确认】",8:"编　　制：何思源（项目负责人）",9:"审　　核：严宇（技术负责人）",10:"批　　准：【待人工确认】",11:"编制日期：2026 年 9 月 21 日",14:"修订记录",15:"注：本表只记录可核验的版本事件；B 独立复核通过前，本文件保持评审候选。"}
    ...
    revisions=[
        ["V0.1","2026-09-20","全文","建立 G3-14 风险管理计划与风险登记册 v2，覆盖识别、评价、责任、触发、应对、复核、关闭及 AC-G2-FR-006-01 专项核对。","何思源"],
        ["V0.2","2026-09-21","§2—§9","按 ISSUE-G3-14-001/002 统一风险评分分组，并为 7 张业务表补齐连续、紧邻的编号题注；风险 ID、P/I、责任、应对和 Issue 状态不变。","何思源"],
    ]
