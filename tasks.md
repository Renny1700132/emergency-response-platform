...
| G4-07 | Sprint 1 | Sprint 1 契约、集成、E2E 与质量门禁 | C | B | G4-05、G4-06 | Sprint 1 契约/集成/E2E 报告、覆盖率与安全结果、缺陷/门禁结论 | 核心事件闭环在干净环境通过；OpenAPI 零 schema error；核心覆盖率 `≥70%`；高危安全问题 0；阻断缺陷 0；RTM/tasks 更新且可回指 PR/本地质量门禁 | DOING |
