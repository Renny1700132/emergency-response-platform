...
| G4-ACCEPTANCE-PPT-01 | 独立汇报 | 项目介绍与阶段性验收汇报 PPT | A | C | G4-07 DONE；`BASELINE-G3-M3-R1.0` FROZEN；用户直接授权 | 17—20 页可编辑 PPTX、逐页中文讲稿、真实截图资产与来源清单、全页渲染 QA | 正文覆盖完整目标能力；截图逐张标记 FORMAL_FRONTEND / PROTOTYPE_TARGET / SIMULATED_DATA；讲稿如实区分当前正式实现与目标界面；10—15 分钟；逐页及全页渲染检查通过；不提前宣称 G4-08—G4-11 完成 | PENDING_REVIEW |
