...
| G3-09 | 测试计划 | C | A（本轮按 OVR-025 单人复核） | G3-03—G3-08 | spec AC、RTM、设计文档集、GB/T 15532 | 《测试计划》与测试左移准入/准出依据 | REVIEW（2026-09-19 A 整改复验：`ISSUE-G3-09-001` 已关闭；39 FR/34★/117 AC/TC、PE-01—12、P0-01—08、表 8-1 可读性、图替代文本与证据边界通过。`ISSUE-G3-09-002` 复验失败：目录将第 9/10 章及附录 A 均标为第 11 页，实际正文页码为 7/8/8，保持 OPEN 并阻断 DONE。尚未执行测试；`ISSUE-G3-01-001` 保持 OPEN） |
