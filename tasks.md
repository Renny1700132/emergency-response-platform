...
| G3-11 | 项目管理计划 | A | C | G3-02 | plan/WBS、里程碑、资源与依赖 | 项目管理计划正式件；范围/资源/里程碑/偏差处置完整，抽查 AC-G2-FR-015-03 | REVIEW（2026-09-19 A 已完成 V0.1 工作稿与正式候选：范围、三人多角色资源、WIP、里程碑/依赖、沟通、质量/配置、偏差/变更和风险管理完整；AC-G2-FR-015-03 的逾期催办、临时任务、改派及后续处置留痕已形成专项抽查设计。正式件按 Reference 22 物理复制重排，8 页全页视觉 QA、样例残留与格式 manifest 通过；ISSUE-G3-01-001/ISSUE-G3-10-001 仍 OPEN，待 C 复核后方可置 DONE） |
