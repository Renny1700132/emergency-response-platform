...
业务恢复范围：用户已于 2026-09-09 明确允许 B 先行开展 G1-04 中不依赖需求基线的技术准备工作。G1-04 可编制技术问题、方案骨架与技术风险输入；需求数字、范围解释、接口能力和验收承诺须等待 G1-01/G1-02 完成后再定稿。其余业务任务在用户或其主责成员明确恢复前保持暂停。
...
| G1-04 | 技术方案 | B | A | G1-02 | 需求基线、接口与非功能条款 | 架构、功能、数据接口、非功能与验证方案 | BLOCKED |
