...
| G3-07 | ADR 与非功能设计 | B | A、C | G3-01、G3-03 | 架构候选、spec 非功能 AC、GB/T 25000.10 | 至少 2 份 ADR、非功能设计与工程规则 | REVIEW（B 已完成 ADR-001/002 Proposed、PE-01—12 非功能设计及 ENG-001—020 工程规则；A 已复核 PASS 并关闭 `ISSUE-G3-07-001`；C 符合性复核 PASS，登记 `ISSUE-G3-07-002`（MINOR，NFR §11 未决状态表述过期，待 B 更正）；仍待 ADR 人工接受，不得置 DONE） |
