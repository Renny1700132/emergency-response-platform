...
当前进展：G1-01、G1-01-A、G1-01-A-BR、G1-02、G1-03、G1-04、G1-05、G1-06 与 G1-07 已完成，12 项需求澄清 Issue、ISSUE-G1-03-001—002、ISSUE-G1-05-001 及 ISSUE-G1-06-001—005 已闭环。G1-07 的计划关联已在 G1-06 准出时完成非阻断滚动复查；其余后续任务保持既定状态。
...
| G1-08 | 技术投标书整合 | A | C、B | G1-03、G1-04、G1-05、G1-06、G1-07 | 全部第一关工作稿 | 技术投标书整合稿 | REVIEW |
| G1-09 | 合规检查 | C | B | G1-08 | 投标书、合规矩阵、facts、key_numbers | 符合性检查记录与 Issue | DONE |
| G1-10 | 技术检查 | A | B（技术确认/复核） | G1-08 | 技术方案、需求条款、验证安排 | 技术检查记录与 Issue | REVIEW |
| G1-11 | 跨文档一致性检查 | A | C | G1-09、G1-10 | 全部正式候选产物、控制文件 | 一致性检查记录与修订清单 | REVIEW |
| G1-12 | 述标与模拟质询 | A | C | G1-11 | 冻结候选稿、澄清记录、风险与证据 | 述标稿、问答清单、模拟质询记录 | TODO |
| G1-13 | 需求确认书 | A | B、C | G1-12 | 冻结候选稿、述标与模拟质询结论、澄清记录 | 需求确认书候选稿与确认项清单 | TODO |
| G1-14 | 最终冻结与归档 | A | C | G1-13 | 全部通过复核的产物与日志 | BASELINE-V1.0、归档清单、冻结记录 | TODO |
