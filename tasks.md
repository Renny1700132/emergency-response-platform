...
| G3-09 | 测试计划 | C | A（本轮按 OVR-025 单人复核） | G3-03—G3-08 | spec AC、RTM、设计文档集、GB/T 15532 | 《测试计划》与测试左移准入/准出依据 | REVIEW（2026-09-19 C 第二次整改：静态目录第 9/10 章及附录 A 页码已最小更正为 7/8/8；Word 16 只读重新渲染 11 页并逐页核对，39 FR/34★/117 AC/TC、PE-01—12、P0-01—08 与正文均未变化。`ISSUE-G3-09-002` 为 `RESOLVED_BY_C / PENDING_A_REVERIFY`，等待 A 按 OVR-025 再复验；尚未执行测试，`ISSUE-G3-01-001` 保持 OPEN） |
