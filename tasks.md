...
| G3-02 | 工程计划、WBS、分工与 constitution 规划 | A | B、C | G3-00、G3-01 | G3 输入基线、架构候选、任务书 | `plan.md`/WBS/任务原子化规划、分工与 constitution 规划稿 | REVIEW |
...
| G3-11 | 项目管理计划 | A | C | G3-02 | plan/WBS、里程碑、资源与依赖 | 项目管理计划正式件 | TODO |
| G3-12 | 质量管理计划 | C | B | G3-02 | AC、PE、评审与测试门禁 | 质量管理计划正式件 | TODO |
| G3-13 | 配置管理计划 | A | C | G3-02 | 基线、版本与变更纪律 | 配置管理计划正式件 | TODO |
| G3-14 | 风险管理计划 | A | B | G3-02 | 开放Issue、外部依赖、NFR风险 | 风险管理计划正式件 | TODO |
