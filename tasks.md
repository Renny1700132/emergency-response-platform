...
| G3-09 | 测试计划 | C | A、B | G3-03—G3-08 | spec AC、RTM、设计文档集、GB/T 15532 | 《测试计划》与测试左移准入/准出依据 | REVIEW（2026-09-19 C 主责完成 V0.1 候选：39 FR、34★、117 AC 对应 117 个稳定 TC 编号；测试级别、范围、策略、进度、环境、准入准出、8 个 P0 场景、PE-01—12 与证据字段齐全；正式件按 Reference 21 物理模板生成并完成 11 页逐页渲染 QA。尚未执行测试，待 A/B 独立复核；`ISSUE-G3-01-001` 保持 OPEN） |
