...
| G3-06 | 接口设计与 OpenAPI | B | A、C | G3-03、G3-05 | 模块边界、外部责任边界、数据设计 | 接口设计说明书、OpenAPI 契约与版本策略 | REVIEW（B 已完成接口说明书、57 个 OpenAPI 操作、39 FR/117 AC 接口挂接与版本策略；`ISSUE-G3-01-001` 继续阻断视频/消息真实外部契约及 G3-06 最终冻结，待 A/C 复核） |
