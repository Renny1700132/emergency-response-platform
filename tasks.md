...
| G4-09 | Sprint 2 | Sprint 2 剩余 MVP 前端/态势/安防接线 | A | C | G4-07；G4-03；与 G4-08 契约先行 | 剩余 MVP Web/H5、指挥态势、安防接线与测试 | 剩余 MVP 前端 AC 可通过正式 API 验证；地图/视频/安防状态和降级可见；控制操作有权限与二次确认；兼容/E2E 证据与 PR 门禁完整 | DOING |
