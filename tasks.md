...
当前进展：G1-01、G1-01-A、G1-01-A-BR、G1-02 与 G1-04 已完成，12 项需求澄清 Issue 已解除 Blocking；G1-03 处于 `REVIEW`，G1-05 可按用户或 C 的明确启动继续。其余后续任务保持既定状态。
...
| G1-05 | 合规矩阵与澄清 | C | B | G1-02、G1-04 | 条款清单、技术方案 | 合规矩阵、★检查、澄清与质询记录 | DOING |
