...
当前进展：G1-01、G1-01-A、G1-01-A-BR、G1-02、G1-03、G1-04 与 G1-05 已完成，12 项需求澄清 Issue、ISSUE-G1-03-001—002 及 ISSUE-G1-05-001 已闭环。G1-05 已形成 168 行目录矩阵、228 行原子条款表、20 项法规标准映射及 B 正式复核记录。G1-06 及其余后续任务保持既定状态，未自动启动。
...
| G1-07 | 风险登记册 v1 | A | C | G1-04、G1-06 | 技术风险、计划与接口依赖 | 风险登记册 v1 | REVIEW |
