...
| G4-06 | Sprint 1 | Sprint 1 Web/H5 前端闭环 | A | C | G4-03；G4-04 可用；与 G4-05 契约先行 | 事件处置 Web/H5 页面、状态与权限交互、附件/反馈最小闭环及测试 | 可经正式 API Client 完成核心演示路径；加载/空/失败/无权状态可见；不直连数据库或原型 Store；组件/交互/E2E 测试通过；PR 门禁完整 | DONE |
