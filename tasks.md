...
| G3-09 | 测试计划 | C | A（本轮按 OVR-025 单人复核） | G3-03—G3-08 | spec AC、RTM、设计文档集、GB/T 15532 | 《测试计划》与测试左移准入/准出依据 | REVIEW（2026-09-19 A 独立审核：39 FR、34★、117 AC/TC、8 个 P0、PE-01—12 与证据边界通过；`ISSUE-G3-09-001/002` OPEN，分别涉及 G3-08 前置状态/复核主体一致性及正式件目录、核心长表可读性与图替代文本，阻断 DONE。尚未执行测试；`ISSUE-G3-01-001` 保持 OPEN） |
