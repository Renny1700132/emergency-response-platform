...
| G3-11 | 项目管理计划 | A | C | G3-02 | plan/WBS、里程碑、资源与依赖 | 项目管理计划正式件；范围/资源/里程碑/偏差处置完整，抽查 AC-G2-FR-015-03 | REVIEW（2026-09-20 C 符合性复核：内容层面 PASS，39 FR/34★/117 AC、29+10 范围、资源/WIP、里程碑/依赖、偏差/变更、两项 OPEN 阻断及 AC-G2-FR-015-03 均与受控输入一致，Markdown—DOCX 182/182 内容块镜像且无案例污染/无障碍问题。正式件目录存在重复标题，且 LibreOffice 9 页渲染下第 10 章位于正文第 6 页、静态目录仍标第 5 页；登记 `ISSUE-G3-11-001`，等待 A 整改后由 C 复验，暂不准出 DONE） |
